    ...
    <div className="my-6 mt-12 ">
      <div className="max-w-6xl mx-auto">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-4xl font-bold">What's People Say</h2>
          <div className="w-44 mx-auto mt-3">
            <Hr />
          </div>
          <p className="text-sm mt-4 leading-relaxed">
            Public libraries are one of the common resource in spreading the
            education or knowledge in the country. I believe that the public
            libraries should be promoted instead of thinking they are a waste of
            money. I will discuss either they are public resource or a waste of
            money in the upcoming passages.
          </p>
        </div>
        <div className="grid md:grid-cols-3 md:gap-6 max-md:gap-10 max-md:justify-center mt-16">
          <div className="max-w-[350px] h-auto shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] lg:p-8 p-4 rounded-md  relative">
            ...
            <div className="mt-4">
              <p className="text-sm leading-relaxed">
                ...
                impressively prompt. Elit occaecat officia et laboris Lorem
